...
Q = 1; % Anelastic attenuation factor [-]
...
r = 1e9; % Creation of break variable [-]
while r>3e-3
    ...
    V_1(2:nx-1) = V_1(2:nx-1) + 1/rho * diff(S)/dx *dt - V_1(2:nx-1).*2*pi/Q/T*dt; % Calculate new itération displacement speed [m.s⁻¹]
