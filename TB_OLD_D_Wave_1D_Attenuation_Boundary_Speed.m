...
Vx = 2000; % Horizontal speed of wave [m.s⁻¹]
...
dt = (lenght+2*B)/Vx/nx; % number of second by mathematical boxes to match wave speed [s]
...
while r>3e-3
    ...
    r = sum(abs(V_1-V_0)); % Calculating new trigger break condition, rest between V_1 and V_0
